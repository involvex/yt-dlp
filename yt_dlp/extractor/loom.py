...
class LoomIE(InfoExtractor):
    ...
    _TESTS = [
        ...
        },
        {
            ...
            ],  # transcoded-url no longer available
        },
        {
            # password-protected
    ...
    def _call_graphql_api(
        self, operation_name, video_id, note=None, errnote=None, fatal=True
    ):
    ...
    def _extract_formats(self, video_id, metadata, video_data):
        ...
        cdn_url = traverse_obj(
            video_data, ("data", "getVideo", "nullableRawCdnUrl", "url", {url_or_none})
        )
    ...
    def _get_subtitles(self, video_id):
        subs_data = self._call_graphql_api(
            ...
            video_id,
            "Downloading GraphQL subtitles JSON",
            fatal=False,
        )
        return filter_dict(
            {
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            "chapters": self._extract_chapters_from_description(
                traverse_obj(
                    chapter_data, ("data", "fetchVideoChapters", "content", {str})
                ),
                duration,
            )
            or None,
