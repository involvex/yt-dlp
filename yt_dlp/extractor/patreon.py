...
class PatreonIE(PatreonBaseIE):
    ...
    def _extract_from_media_api(self, media_id):
        ...
        playback_url = traverse_obj(
            attributes,
            ("display", (None, "viewer_playback_data"), "url", {url_or_none}, any),
        )
        ...
        if playback_url and mimetype2ext(attributes.get("mimetype")) == "m3u8":
            ...
            if transcript_url := traverse_obj(
                attributes, ("display", "transcript_url", {url_or_none})
            ):
            ...
            info_dict["formats"] = [
                {
                    ...
                    "vcodec": (
                        "none" if attributes.get("media_type") != "video" else None
                    ),
                }
            ]
    ...
    def _real_extract(self, url):
        ...
        for media_id in traverse_obj(
            ...
            (
                ...
                {
                    find_elements(
                        attr="data-media-id", value=r"\d+", regex=True, html=True
                    )
                },
                ...,
                {extract_attributes},
    ...
    def _real_extract(self, url):
        ...
        if campaign_id is None:
            ...
            campaign_id = traverse_obj(
                results,
                (
                    lambda _, v: v["type"] == "campaign-document"
