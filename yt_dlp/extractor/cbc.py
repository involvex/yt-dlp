        ...
        media_ids.extend(
            traverse_obj(
                ...
                (
                    ...
                    ...,
                    "content",
                    lambda _, v: v["type"] == "polopoly_media",
                    "content",
                    "sourceId",
                    {str},
                ),
    ...
    def _call_media_api(self, media_id, app_code="gem", display_id=None, headers=None):
        ...
        if error_code != 0:
            error_message = join_nonempty(
                error_code, media_data.get("message"), delim=" - "
            )
...
class CBCGemIE(CBCGemBaseIE):
    ...
    def _real_extract(self, url):
        ...
        m3u8_url = self._call_media_api(
            item_info["idMedia"], display_id=video_id, headers=headers
        )["url"]
...
class CBCGemContentIE(CBCGemBaseIE):
    ...
    def _real_extract(self, url):
        ...
        def entries():
            for playlist_url in traverse_obj(
                data,
                (
                    "content",
                    ...,
    ...
    def _real_extract(self, url):
        ...
        item_info = traverse_obj(
            ...
            (
                ...
                ...,
                "items",
                lambda _, v: v["formattedIdMedia"] == media_id,
                any,
                {require("item info")},
            ),
        )
        ...
        if (
            ...
            formats = self._extract_m3u8_formats(
                m3u8_url, video_id, "mp4", live=live_status == "is_live"
            )
...
class CBCGemLiveIE(CBCGemBaseIE):
    ...
    def _real_extract(self, url):
        ...
        if (
            ...
            m3u8_url = self._call_media_api(video_stream_id, "medianetlive", video_id)[
                "url"
            ]
            formats = self._extract_m3u8_formats(
                m3u8_url, video_id, "mp4", live=live_status == "is_live"
