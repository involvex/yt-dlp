...
class TestJSInterpreter(unittest.TestCase):
    ...
    def test_operators(self):
        ...
        self._test(
            'function f(){return "life, the universe and everything" < 42;}', False
        )
    ...
    def test_assignments(self):
        ...
        self._test(
            'function f(){var x = 2; var y = ["a", "b"]; y[x%y["length"]]="z"; return y}',
            ["z", "b"],
        )
    ...
    def test_finally(self):
        ...
        self._test(
            "function f() { try{throw 10} catch(e){return 5} finally {return 42} }", 42
        )
    ...
    def test_for_loop_continue(self):
        self._test(
            "function f() { a=0; for (i=0; i-10; i++) { continue; a++ } return a }", 0
        )

    def test_for_loop_break(self):
        self._test(
            "function f() { a=0; for (i=0; i-10; i++) { break; a++ } return a }", 0
        )
    ...
    def test_object(self):
        ...
        self._test(
            "function f() { let a = {m1: 42, m2: 0 }; return a?.qq; }", JS_Undefined
        )
    ...
    def test_regex(self):
        ...
        self._test(
            "function f() { let a=/,,[/,913,/](,)}/; return a; }", R"/,,[/,913,/](,)}/0"
        )
    ...
    def test_replace(self):
        self._test(
            'function f() { let a="data-name".replace("data-", ""); return a }', "name"
        )
        self._test(
        ...
        self._test(
            'function f() { let a="data-name".replace(/^.+-/, ""); return a; }', "name"
        )
        self._test(
    ...
    def test_slice(self):
        ...
        self._test(
            "function f(){return [0, 1, 2, 3, 4, 5, 6, 7, 8].slice(5)}", [5, 6, 7, 8]
        )
        ...
        self._test(
            "function f(){return [0, 1, 2, 3, 4, 5, 6, 7, 8].slice(3, 6)}", [3, 4, 5]
        )
        self._test(
        ...
        self._test(
            "function f(){return [0, 1, 2, 3, 4, 5, 6, 7, 8].slice(-3, -1)}", [6, 7]
        )
    ...
    def test_extract_object(self):
        jsi = JSInterpreter(
            'var a={};a.xy={};var xy;var zxy={};xy={z:function(){return "abc"}};'
        )
    ...
    def test_increment_decrement(self):
        ...
        self._test(
            'function f() { var y; var x = 1; x++, --x, x--, x--, y="z", "abc", x++; return --x }',
            -1,
        )
