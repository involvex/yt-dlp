...
class TestInstanceStoreMixin:
    ...
    def test_mixin(self):
        ...
        assert mixin._get_instance(d={"a": 1}, e=[1, 2, 3]) == mixin._get_instance(
            d={"a": 1}, e=[1, 2, 3]
        )
        ...
        assert mixin._get_instance(b=[1, 2], c=cookiejar) == mixin._get_instance(
            b=[1, 2], c=cookiejar
        )

        assert mixin._get_instance(b=[1, 2], c=cookiejar) != mixin._get_instance(
            b=[1, 2], c=YoutubeDLCookieJar()
        )

        # Different order
        assert mixin._get_instance(c=cookiejar, b=[1, 2]) == mixin._get_instance(
            b=[1, 2], c=cookiejar
        )
