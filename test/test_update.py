...
class TestUpdate(unittest.TestCase):
    ...
    def test_update_spec(self):
        ...
        for lockfile in (
            ...
            test(
                lockfile, "darwin_legacy_exe Python 3.10.5", "2025.08.11", "2025.08.11"
            )
            test(
                lockfile,
                "darwin_legacy_exe Python 3.10.5",
                "2025.08.11",
                "2025.08.11",
                exact=True,
            )
            test(
                lockfile, "darwin_legacy_exe Python 3.10.5", "2025.08.12", "2025.08.11"
            )
            test(
                lockfile,
                "darwin_legacy_exe Python 3.10.5",
    ...
    def test_query_update(self):
        ...
        def test(
            target, expected, current_version=None, current_commit=None, identifier=None
        ):
        ...
        test(
            "fork/yt-dlp@pr9999",
            UpdateInfo("pr9999", version=None, requested_version=None, commit="1" * 40),
        )
        test(
            "fork/yt-dlp-satellite@pr987",
            UpdateInfo("pr987", version=None, requested_version=None, commit="2" * 40),
        )
    ...
    def test_make_label(self):
        ...
        for inputs, expected in [
            (
                [STABLE_REPO, "2025.09.02", "2025.09.02"],
                f"stable@2025.09.02 from {STABLE_REPO}",
            ),
            (
                [NIGHTLY_REPO, "2025.09.02.123456", "2025.09.02.123456"],
                f"nightly@2025.09.02.123456 from {NIGHTLY_REPO}",
            ),
            (
                [MASTER_REPO, "2025.09.02.987654", "2025.09.02.987654"],
                f"master@2025.09.02.987654 from {MASTER_REPO}",
            ),
            (
                ["fork/yt-dlp", "experimental", "2025.12.31.000000"],
                "fork/yt-dlp@experimental build 2025.12.31.000000",
            ),
            (["fork/yt-dlp", "2025.09.02", "2025.09.02"], "fork/yt-dlp@2025.09.02"),
            (
                [STABLE_REPO, "experimental", "2025.12.31.000000"],
                f"{STABLE_REPO}@experimental build 2025.12.31.000000",
            ),
